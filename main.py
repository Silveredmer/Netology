...
class VKBot:
    ...
    def send_photo_1(self, user_id, message, offset):
        self.vk.method('messages.send', {'user_id': user_id,
                                         ...
                                         'message': message,
                                         'attachment': f'photo{self.person_id(offset)}_'
                                                       f'{self.get_photo_1(self.person_id(offset))}',
                                         'random_id': 0})
    ...
    def send_photo_2(self, user_id, message, offset):
        self.vk.method('messages.send', {'user_id': user_id,
                                         ...
                                         'message': message,
                                         'attachment': f'photo{self.person_id(offset)}_'
                                                       f'{self.get_photo_2(self.person_id(offset))}',
                                         'random_id': 0})
    ...
    def send_photo_3(self, user_id, message, offset):
        self.vk.method('messages.send', {'user_id': user_id,
                                         ...
                                         'message': message,
                                         'attachment': f'photo{self.person_id(offset)}_'
                                                       f'{self.get_photo_3(self.person_id(offset))}',
                                         'random_id': 0})
